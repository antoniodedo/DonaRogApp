...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p aa169bb4-aa4e-4cc9-ba9c-f77ae427a255
```

> `aa169bb4-aa4e-4cc9-ba9c-f77ae427a255` is the password of the certificate, you can change it to any password you want.
