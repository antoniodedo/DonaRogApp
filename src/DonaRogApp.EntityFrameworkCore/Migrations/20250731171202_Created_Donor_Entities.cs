...
{
    /// <inheritdoc />
    public partial class Created_Donor_Entities : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WantsThanks = table.Column<bool>(type: "bit", nullable: false),
                    PaperDeliveryEnabled = table.Column<bool>(type: "bit", nullable: false),
                    EmailDeliveryEnabled = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RawAddress = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Dug = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TenantId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    DonorId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    RelatedDonorId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DonorRelationships", x => x.Id);
                    table.ForeignKey(
